...
~~5. Create Intro Sequence (level 1)~~

6. Create Tutorial Level 2 (Movement)
7. Design and Create Tutorial Level 3 (Laser Fields)
8. Need to create a HUD timer countdown, for all non-tutorial levels
9. Design and Create Level 4 (Regulatory Infiltration)
